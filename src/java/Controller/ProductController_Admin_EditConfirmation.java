 ...
 * @author Ashley
 */
@WebServlet(name = "ProductController_Admin_EditConfirmation", urlPatterns = {"/ProductController_Admin_EditConfirmation"})
public class ProductController_Admin_EditConfirmation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            prodDA.updateRecord(prod);

            String msg = "Product with the Product ID of " + prod.getProdID() + " has been updated to the database.";
