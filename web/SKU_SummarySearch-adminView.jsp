<%-- 
    Document   : SKU_SummarySearch-adminView
    Created on : Mar 30, 2022, 1:25:38 PM
                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <!--View button-->
                                                        <a href='${pageContext.request.contextPath}/SKUController?selectedRow=1&action=getSku'><i class='fas fa-book' id="tableBody-link-icon"></i></a>
                                                        <!--Edit button-->
                                                        <a href='${pageContext.request.contextPath}/SKU_Update-adminView.jsp?selectedRow=1' title="Edit"><i class='fas fa-pen' id="tableBody-link-icon"></i></a>
                                                        <!--Delete button-->
                                                        <a href='${pageContext.request.contextPath}/SKUController?selectedRow=1&action=deleteSku' title="Delete"><i class='fas fa-trash-alt' id="tableBody-link-icon"></i></a>
                                                    </td>
                                                    <td>1</td>
                                                    <td><%= sku.getSkuNo()%></td>
                                                    <td><%= sku.getProduct().getProdID()%></td>
                                                    <td><%= sku.getColour()%></td>
                                                    <td><%= sku.getSkuQty()%></td>
                                                </tr>
                                            </tbody>
