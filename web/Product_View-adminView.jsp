<%-- 
    Document   : Product_View-adminView
    Created on : Mar 31, 2022, 9:11:46 PM
    Author     : Ashley
--%>
...
<html>
    <head>
        ...
        <title>Product View - Fast&Fashion</title>
    </head>
    <body>
                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                <form id="product" method="get" action="ProductController_Admin_View">
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><%= prod.getProdImage()%></br><img src="<%= prod.getProdImage()%>" alt="Product image" class="product-image" style="width: 250px;"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
