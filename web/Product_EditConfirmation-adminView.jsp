<%-- 
    Document   : Product_EditConfirmation-adminView
    Created on : Apr 2, 2022, 10:10:07 PM
    Author     : Ashley
--%>
    ...
    <body>
                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                <form id="product" method="post" action="ProductController_Admin_EditConfirmation">
        ...
        <script>
                                    document.querySelector('#action-button').addEventListener('click', () => {
                                        Confirm.open({
                                            title: 'Edit Product',
                                            message: 'Are you confirm to edit the product ?',
                                            onok: () => {
