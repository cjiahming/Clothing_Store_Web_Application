<%-- 
    Document   : User_View-adminView
    Created on : Apr 4, 2022, 7:58:37 PM
    Author     : jiyeo
--%>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                ...
                                <br/>
                                <fieldset>
                                    <legend> Access Rights for <b><%= admin.getUsername()%></b> </legend><br/>
                                    <table id="accessRightLists">
                                        ...
                                        <tr>
                                            <td><%= pageTitle[i]%></td>
                                            <td><% if (admin.getUserGroup().getAccessRights().charAt(i + 1) == '1') { %>
                                            ...
                                            <td><%= pageTitle[i+7]%></td>
                                            <td><% if (admin.getUserGroup().getAccessRights().charAt((i+7) + 1) == '1') { %>
                                                <p class="acStatus">✅ Active  </p>
                                                <% } else { %>
                                                <p class="nonAcStatus">⛔ Denied  </p>
                                                <% } %>
