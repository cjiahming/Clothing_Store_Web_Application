<%-- 
    Document   : Product_Delete-adminView
    Created on : Apr 1, 2022, 12:05:59 AM
    Author     : Ashley
--%>
...
<html>
    <head>
        ...
        <title>Product Delete - Fast&Fashion</title>
    </head>
    <body>
                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                <form id="product" method="post" action="ProductController_Admin_Delete">
                                ...
                                <button id="action-button" name="next" value=""><i class="fas fa-trash-alt"></i></button>
        ...
        <script>
                                    document.querySelector('#action-button').addEventListener('click', () => {
                                        Confirm.open({
                                            ...
                                            message: 'Are you confirm to delete the product ?',
                                            onok: () => {
