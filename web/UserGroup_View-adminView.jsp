<%-- 
    Document   : UserGroup_View-adminView
    Created on : Mar 18, 2022, 6:01:28 PM
    Author     : jiyeo
--%>
...
<html>
    <head>
        ...
        <title>View User Group - Fast&Fashion</title>
    </head>
    <body>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                ...
                                <fieldset>
                                    <legend> Access Rights </legend><br/>
                                    <table id="accessRightLists">
                                        ...
                                        <button id="action-button2" type="button" name="back" onclick="history.back()"><i class="fa fa-chevron-left"></i></button><br/>
                            </div>
                        </div>
                    </div>
                </main>
