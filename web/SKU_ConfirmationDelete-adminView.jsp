<%-- 
    Document   : SKU_ConfirmationDelete-adminView
    Created on : Mar 28, 2022, 3:07:50 PM
...
<html>
    <head>
        ...
        <title>SKU Delete Confirmation - Fast&Fashion</title>
    </head>
    <body>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                ...
                                <form id="sku" method="post" action="SkuDBDeleteController">
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><%= sku.getColour()%></td>
                                                <td><%= sku.getProdSize()%></td>
                                                <td><%= sku.getProdWidth()%></td>
                                                <td><%= sku.getProdLength()%></td>
                                                <td><%= sku.getSkuQty()%></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <!--next button that will call the action to delete the record-->
                                <button id="action-button" name="next" value="delete"><i class="fas fa-trash-alt"></i></button>
    ...
    <script>
                                    document.querySelector('#action-button').addEventListener('click', () => {
                                        Confirm.open({
                                            title: 'Delete SKU',
                                            message: 'Are you confirm to delete the SKU ?',
                                            onok: () => {
