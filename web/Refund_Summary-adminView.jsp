<%-- 
    Document   : Refund_Summary-adminView
    Created on : Apr 4, 2022, 2:48:28 PM
...
<%
    ...
    if(admin.getUserGroup().getAccessRights().charAt(9)=='0'){ 
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                //retrive all the refund records from the refund table
