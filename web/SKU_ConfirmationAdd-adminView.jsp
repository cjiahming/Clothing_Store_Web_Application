<%-- 
    Document   : SKU_ConfirmationAdd-adminView
    Created on : Mar 20, 2022, 12:24:05 PM
...
<html>
    <head>
        ...
        <title>SKU Add New Confirmation - Fast&Fashion</title>
    </head>
    <body>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4" id="innerPart">
                            ...
                            <div class="card-body">
                                ...
                                <form id="sku" method="post" action="SkuDBAddController">
                                ...
                                <!--next button that will call the action to save the record-->
                                <button id="action-button" name="next" value="add"><i class="fa fa-save"></i></button>
    ...
    <script>
                                    document.querySelector('#action-button').addEventListener('click', () => {
                                        Confirm.open({
                                            title: 'Save SKU',
                                            message: 'Are you confirm to save the SKU ?',
                                            onok: () => {
